...
<body id="page-top">
    ...
    <div class="card-body d-flex flex-row justify-content-center align-items-center mb-4">
        ...
        <div class="dropdown me-2">
            <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">승인여부</button>
        ...
        <div class="dropdown me-2">
            <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">카테고리</button>
            <ul class="dropdown-menu">
        ...
        <table id="tab" class="table table-hover">
            ...
            <c:forEach var="lectureList" items="${ requestScope.lecList}" varStatus="i">
                ...
                <tr>
                    ...
                    <td>
                  		<c:out value="${lectureList.reason }"/>
                    </td>	
                </tr>
                </c:forEach>
            </tbody>
