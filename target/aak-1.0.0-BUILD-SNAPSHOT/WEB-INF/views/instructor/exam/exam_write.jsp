            ...
            <form action="exam_write_pr.do" id="frm" method="post">
                <div id="test">
                    ...
                    <div class="test-box">
                        ...
                        <textarea name="CONTENT[]" placeholder="문제를 입력하세요"></textarea> <br>
                        1번 보기 <input type="radio" name="SOLUTION[0]" value="1" /><input type="text" name="EX_1[]" placeholder="보기를 입력하세요"/> <br>
                        2번 보기 <input type="radio" name="SOLUTION[0]" value="2" /><input type="text" name="EX_2[]" placeholder="보기를 입력하세요"/> <br>
                        3번 보기 <input type="radio" name="SOLUTION[0]" value="3" /><input type="text" name="EX_3[]" placeholder="보기를 입력하세요"/> <br>
                        4번 보기 <input type="radio" name="SOLUTION[0]" value="4" /><input type="text" name="EX_4[]" placeholder="보기를 입력하세요"/> <br>
                    </div>
                    ...
                    <div class="test-box">
                        번호 <input type="text"  name="Q_NO[]" readonly/><br>
                        <textarea name="CONTENT[]" placeholder="문제를 입력하세요"></textarea> <br>
                        1번 보기 <input type="radio" name="SOLUTION[1]" value="1" /><input type="text" name="EX_1[]" placeholder="보기를 입력하세요"/> <br>
                        2번 보기 <input type="radio" name="SOLUTION[1]" value="2" /><input type="text" name="EX_2[]" placeholder="보기를 입력하세요"/> <br>
                        3번 보기 <input type="radio" name="SOLUTION[1]" value="3" /><input type="text" name="EX_3[]" placeholder="보기를 입력하세요"/> <br>
                        4번 보기 <input type="radio" name="SOLUTION[1]" value="4" /><input type="text" name="EX_4[]" placeholder="보기를 입력하세요"/> <br>
                    </div>
                    ...
                    <div class="test-box">
                        번호 <input type="text"  name="Q_NO[]" readonly/><br>
                         <textarea name="CONTENT[]" placeholder="문제를 입력하세요"></textarea> <br>
                        1번 보기 <input type="radio" name="SOLUTION[2]" value="1" /><input type="text" name="EX_1[]" placeholder="보기를 입력하세요"/> <br>
                        2번 보기 <input type="radio" name="SOLUTION[2]" value="2" /><input type="text" name="EX_2[]" placeholder="보기를 입력하세요"/> <br>
                        3번 보기  <input type="radio" name="SOLUTION[2]" value="3" /><input type="text" name="EX_3[]" placeholder="보기를 입력하세요"/><br>
                        4번 보기 <input type="radio" name="SOLUTION[2]" value="4" /><input type="text" name="EX_4[]" placeholder="보기를 입력하세요"/> <br>
                    </div>
                </div>
                <div class="text-end">
                    <input type="button" id="btn-end" value="작성완료" class="btn btn-info btn-sm"/>
		<a href="examList.do"><button class="btn btn-info btn-sm" >취소</button></a>
                </div>
            </form>
        </div>
    </section>
