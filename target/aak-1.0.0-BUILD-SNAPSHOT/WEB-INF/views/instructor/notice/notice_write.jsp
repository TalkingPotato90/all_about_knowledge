...
<script type="text/javascript">
    ...
    function updateSubCode() {
        ...
        var subCodeInput = document.getElementById("SUB_CODE");

        // 선택된 옵션의 값으로 SUB_CODE input의 값을 업데이트
        subCodeInput.value = subjectSelect.value;
    }
    }
</script>
<body id="page-top">
...
<div class="main">
    ...
    <form action="notice_write_pr.do" id="frm" method="post">
            <input type="hidden" name="INST_ID" value="INST_00001" readonly/><br>
       과목 <select id="subjectSelect" name="SUB_CODE" onchange="updateSubCode()">
    ...
    <option value="SUB_000007">진C화로</option>
            ...
            <table>
                <tr>
                    <td><input type="hidden" name="noti_no" value="${ requestScope.noti_no }" readonly/></td>
                </tr>
                <tr>
...
<a href="notice.do"><button>취소</button></a>
<!-- /main -->
